...
if type yarn > /dev/null 2>&1; then
    ...
    # register.npm.taobao.org

    # curl -sS https://registry.npmmirror.com/debian/pubkey.gpg | sudo apt-key add -
    # echo "deb https://registry.npmmirror.com/debian/ stable main" | sudo tee /etc/apt/sources.list.d/yarn.list
    # apt-get update
    # apt-get -y install --no-install-recommends yarn
fi
